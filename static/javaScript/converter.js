...
embedImages= async ()=>{
    ...
    for(var i=0;i<data.length;i++){
        ...
        //set page size
        page.setSize(jpgImage.width ,jpgImage.height);
        page.drawImage(jpgImage, {
            width: page.getWidth()-0,
            height: page.getHeight()-0,
        })
    }
    ...
    //download pdf file тут можно изменить название
